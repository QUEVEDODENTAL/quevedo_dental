...
const Perfil = () => {
  ...
  <div className="flex flex-col items-center justify-center">
    ...
    <Link href="/dashboard/pacientes">
      <button className="mb-2 w-full px-28 py-2 bg-secondary-button text-white rounded hover:bg-secondary-dash hover:text-primary-white transition-colors duration-300">
