...
const renderizarImagenSup = (numero) => {
  ...
  return (
    <div className="max-w-md bg-primary-red">
        ...
        <fieldset>
          ...
          <div className="form-control">
            <label htmlFor="nombre" className="text-gray-700 ">
              ...
              <br />
            <input type="text" id="nombre" value={nombre} onChange={(e) => setNombre(e.target.value)}className="w-full h-12 text-lg border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" style={{ maxWidth: '400px' }} // Ajusta el ancho máximo del campo de entrada
            />
          </div>
  ...
  <div>
    ...
    <div className="flex items-center mt-2">
      <input 
        ...
        className="mr-1"
      />
      <label htmlFor="hombre" className="mr-3">
        Hombre
      </label>
      <input 
        type="radio" 
      ...
      <label htmlFor="mujer">
        Mujer
          ...
          <div className="form-control text-center mt-8">
            ...
            className="w-full h-12 text-lg border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500" style={{ maxWidth: '400px' }} // Ajusta el ancho máximo del campo de entrada
            />
            <br />
            <br />
          </div>
          ...
          <div className="form-control">
            ...
            <br />
            <input type="date" id="fecha_nacimiento" value={fechaNacimiento} onChange={(e) => setFechaNacimiento(e.target.value)}/>
            <br />
            <br />
          </div>
          <div className="form-control">
            <label htmlFor="escolaridad" className="text-gray-700">
              Escolaridad:
            </label>
            <br />
            <input type="text"id="escolaridad"value={escolaridad} onChange={(e) => setEscolaridad(e.target.value)}/>
            <br />
            <br />
          </div>  
          <div className="form-control">
        ...
        <fieldset>
          <legend className="text-lg font-semibold text-gray-700 bg-transparent text-gray-700 border border-gray-700 hover:bg-gray-100 hover:text-gray-900 py-2 px-4 rounded inline-flex items-center">
            Enfermedades
          </legend>
    ...
    <div className="dientes-grid">
      {[...Array(105).keys()].map(numero => (
        ...
        <fieldset>
          ...
          <div className="form-control">  
            ...
            <div className="color-options">
              ...
              <div className="form-control" style={{ position: 'relative', width: '100px' }}>
                <Image src="/assets/enciaas.jpg" alt="Encías" width={200} height={100} style={{ width: '100%', height: '50' }} />
                {coloracionEncias && (<div className="color-overlay" style={{position: 'absolute',top: 0,left: 0,width: '100%',height: '100%',backgroundColor: coloracionEncias,opacity: 0.5,}}/>)}
              </div>
            </div>
          </div>  
          <div className="form-control">
            <legend>
              Coloración de lengua
            </legend>
          ...
          <div className="form-control">
            <label htmlFor="ulceracionesLengua" className="text-gray-700">
            ...
            <select id="ulceracionesLengua" value={ulceracionesLengua} onChange={(e) => setUlceracionesLengua(e.target.value)}>
              <option value="sin-ulceraciones">
                Sin Ulceraciones
              </option>
              <option value="con-ulceraciones">
                Con Ulceraciones
              </option>
            </select>
            <br />
            <br /> 
            <label htmlFor="observacionesLengua" className="text-gray-700">
