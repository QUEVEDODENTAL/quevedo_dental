    ...
    return (
        <div className="mx-1 my-1 p-4 border-10 custom-shadowa rounded-[15px] lg:w-3/5 md:w-3/4">
            ...
            <div className="mt-8 flex flex-col">
                <button type="submit" name="registrar" className="text-[1rem] p-[10px] rounded-[10px] scale-90 bg-primary-info text-primary-seccion cursor-pointer text-white hover:bg-primary-info hover:text-primary-seccion hover:scale-100 transition-transform duration-300">
                    Registrar
                </button>
            </div>
        </div>
